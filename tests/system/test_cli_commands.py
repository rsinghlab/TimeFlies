"""System tests for TimeFlies CLI commands.

Tests the user-facing command-line interface to ensure proper argument handling,
configuration loading, and error reporting. These tests verify the system works
...
class TestCLIIntegration:
    ...
    def run_cli_command(self, args, cwd=None):
        ...
        cmd = ["python3", "run_timeflies.py"] + args
    ...
    @pytest.mark.slow
    @pytest.mark.skip(reason="CLI integration tests require complex environment setup")
