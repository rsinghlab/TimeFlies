...
from shared.models.model_factory import (
    BaseModel, CNNModel, MLPModel, LogisticRegressionModel, 
    XGBoostModel, RandomForestModel, ModelFactory
)
from shared.utils.exceptions import ModelError
...
class TestCNNModel:
    ...
    @patch('shared.models.model_factory.Sequential')
...
class TestLogisticRegressionModel:
    ...
    @patch('shared.models.model_factory.LogisticRegression')
...
class TestXGBoostModel:
    ...
    @patch('shared.models.model_factory.xgb.XGBClassifier')
...
class TestRandomForestModel:
    ...
    @patch('shared.models.model_factory.RandomForestClassifier')
