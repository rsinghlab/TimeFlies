...
from shared.core.active_config import get_config_for_active_project, get_active_project
from shared.cli.parser import create_main_parser, parse_arguments
from shared.cli.commands import run_system_tests, train_command, evaluate_command
