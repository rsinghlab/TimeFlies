"""
Fruit Fly Alzheimer's Research Project

This module contains Alzheimer's-specific analysis tools for studying
neurodegeneration and related pathways in Drosophila models.
"""
